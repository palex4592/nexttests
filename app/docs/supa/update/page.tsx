...
export default function Home() {
  return (
    <main className="flex-col items-center p-24">
      <h1 className="flex justify-center text-4xl pb-10">UPDATE</h1>
      ...
      <div className="flex justify-center">
        <ButtonNavPrevious path={"/docs/supa/create"} text={"Create"} />
        <ButtonNavNext path={"/docs/supa/delete"} text={"Delete"} />
      </div>
    </main>
  );
}
