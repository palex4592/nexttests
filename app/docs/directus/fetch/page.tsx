...
export default function Home() {
  return (
    <main className="flex-col items-center p-24">
      <h1 className="flex justify-center text-4xl pb-10">FETCH</h1>
      ...
      <div className="flex justify-center">
        <ButtonNavPrevious path={"/docs/directus/setup"} text={"Setup"} />
        <ButtonNavNext path={"/docs/directus/create"} text={"Create"} />
      </div>
    </main>
  );
}
