...
export default function Home() {
  return (
    <main className="flex-col items-center p-24">
      <h1 className="flex justify-center text-4xl pb-10">CREATE</h1>
      ...
      <div className="flex justify-center">
        <ButtonNavPrevious path={"/docs/directus/fetch"} text={"Fetch"} />
        <ButtonNavNext path={"/docs/directus/update"} text={"Update"} />
      </div>
    </main>
  );
}
